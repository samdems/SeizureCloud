...
class MedicationScheduleStoreRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        ...
        // Set default dosage and unit from medication if not provided
        if (
            is_null($this->dosage_multiplier) ||
            $this->dosage_multiplier === ""
        ) {
            $medication = \App\Models\Medication::query()->find(
                $this->medication_id,
            );
        ...
        // Set default unit from medication if not provided
