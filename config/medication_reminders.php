...
return [
    ...
    */
    "spam_prevention" => [
        ...
        "log_retention_days" => env(
            "MEDICATION_REMINDER_LOG_RETENTION_DAYS",
            90,
        ),
    ],
    ...
    */
    "timing" => [
        ...
        "overdue_grace_period_minutes" => env(
        ...
        "respect_quiet_hours" => env(
            "MEDICATION_REMINDER_RESPECT_QUIET_HOURS",
            true,
        ),

        // Skip reminders on weekends for weekly medications
        "skip_weekend_reminders" => env(
            "MEDICATION_REMINDER_SKIP_WEEKENDS",
            false,
        ),
    ],
    ...
    */
    "scheduling" => [
        ...
        "check_frequency_minutes" => env(
            "MEDICATION_REMINDER_CHECK_FREQUENCY",
            15,
        ),

        // Maximum execution time for the reminder command (in seconds)
        "max_execution_time" => env(
            "MEDICATION_REMINDER_MAX_EXECUTION_TIME",
            300,
        ),
    ...
    */
    "notifications" => [
        ...
        "queue_connection" => env(
            "MEDICATION_REMINDER_QUEUE_CONNECTION",
            "database",
        ),

        // From email address for medication reminders
        "from_email" => env(
            "MEDICATION_REMINDER_FROM_EMAIL",
            env("MAIL_FROM_ADDRESS"),
        ),

        // From name for medication reminders
        "from_name" => env(
            "MEDICATION_REMINDER_FROM_NAME",
            env("MAIL_FROM_NAME", "EpiCare Medication Reminders"),
        ),

        // Whether to include medication dosage in email subjects
        "include_dosage_in_subject" => env(
            "MEDICATION_REMINDER_DOSAGE_IN_SUBJECT",
            false,
        ),

        // Maximum number of medications to list in email before summarizing
        "max_medications_in_email" => env(
            "MEDICATION_REMINDER_MAX_IN_EMAIL",
            10,
        ),
    ],
    ...
    */
    "user_defaults" => [
        ...
        "allow_user_disable" => env(
            "MEDICATION_REMINDER_ALLOW_USER_DISABLE",
            true,
        ),

        // Whether users can customize reminder frequency
        "allow_user_custom_frequency" => env(
            "MEDICATION_REMINDER_ALLOW_USER_CUSTOM_FREQUENCY",
            false,
        ),
    ],
    ...
    */
    "progressive_reminders" => [
        ...
        // Reminder schedule: minutes after due time => reminder type
        "schedule" => [
            0 => "due", // Immediate reminder when due
            30 => "overdue", // 30 minutes after due time
            240 => "urgent", // 4 hours after due time
            1440 => "critical", // 24 hours after due time
        ],
    ...
    */
    "analytics" => [
        ...
        "daily_summary_reports" => env(
            "MEDICATION_REMINDER_DAILY_REPORTS",
            false,
        ),
    ...
    */
    "emergency" => [
        ...
        "emergency_notification_emails" => env(
            "MEDICATION_EMERGENCY_EMAILS",
            "",
        ),
    ],
    ...
    */
    "development" => [
        ...
        "auto_create_test_data" => env(
            "MEDICATION_REMINDER_AUTO_TEST_DATA",
            false,
        ),
