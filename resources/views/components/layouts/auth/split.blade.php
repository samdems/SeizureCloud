...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark" data-theme="dark">
    ...
    <body class="min-h-screen bg-white antialiased dark:bg-zinc-900">
        <div class="relative grid h-dvh flex-col items-center justify-center px-8 sm:px-0 lg:max-w-none lg:grid-cols-2 lg:px-0">
            <div class="relative hidden h-full flex-col p-10 text-white lg:flex dark:border-e dark:border-zinc-700 bg-zinc-900">
                ...
                <div class="relative z-20 mt-auto">
                    <blockquote class="space-y-2">
                        <p class="text-xl font-bold">&ldquo;{{ trim($message) }}&rdquo;</p>
